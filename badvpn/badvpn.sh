...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/astrogestor/astro5g/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/astrogestor/astro5g/main/badvpn/antcrashvpn.sh -o /dev/null
