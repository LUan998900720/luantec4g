...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/LUan998900720/luantec4gmain/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/LUan998900720/luantec4gmain/badvpn/antcrashvpn.sh -o /dev/null
